        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Java Developer passionate about building scalable, maintainable, and high-performance applications.
            </p>
            <div className="flex space-x-4">
              <a href="https://github.com/asajwan811" target="_blank" 
    rel="noopener noreferrer" className="text-gray-400 hover:text-java-orange transition-colors duration-200">
    ...
    rel="noopener noreferrer" className="text-gray-400 hover:text-java-orange transition-colors duration-200">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2025 Abhinavjeet. All rights reserved.
          </div>
